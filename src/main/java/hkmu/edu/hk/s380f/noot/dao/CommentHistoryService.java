...
public class CommentHistoryService {
    ...
    public ModelAndView create() {
        return new ModelAndView("add", "blogForm", new BlogController.Form());
    }
    ...
    @PostMapping("/create")
    public View create(BlogController.Form form, Principal principal) throws IOException {
...
/*    @GetMapping("/{blogId}/attachment/{attachment:.+}")
    ...
    public ModelAndView showEdit(@PathVariable("blogId") long blogId,
        ...
        BlogController.Form blogForm = new BlogController.Form();
    ...
    public String edit(@PathVariable("blogId") long blogId, BlogController.Form form,
                       Principal principal, HttpServletRequest request)
